...
export default function DashboardKasir(props) {
    ...
    return (
        ...
        >
            ...
            <div className="relative mt-24 px-4 max-h-[90vh] overflow-y-auto scrollbar-thin scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar-thumb-emerald-400 scrollbar-track-emerald-200">
