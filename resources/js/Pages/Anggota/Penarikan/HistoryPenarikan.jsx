...
export default function HistoryPenarikan(props) {
    const penarikan_bulan = props.penarikan_bulan;
    const penarikan_tahun = props.penarikan_tahun;
    ...
    const cariHandler = (e) => {
        router.get(route("anggota.history-mutasi"), query, {
            preserveState: true,
            preserveScroll: true,
            onSuccess: () => {
    ...
    return (
        <div>
            ...
            <Authenticated>
                <Header
                    header={"Data Transaksi Penarikan Saldo"}
                    message={"Menu ini menampilkan data penarikan saldo anda"}
                />
