            ...
            <Authenticated>
                <div className="flex gap-1 items-center">
                    ...
                    <Buttons
                        ...
                        className={
                            "w-[60px] text-[8pt] mx-4 border border-gray-500"
                        }
                    >
                        Search
                    </Buttons>
                ...
                <div className="my-2.5 mx-4">
                    <h3 className="font-semibold text-teal-400 border-b-4 border-teal-400">
                        {informasi.judul}
                    </h3>
                    <div className="flex justify-between items-center">
                        <p className="text-[8pt] text-gray-700">
                            Post By : {informasi.profile_petugas.nama_petugas}
                        </p>
                        <p className="text-[8pt] text-gray-700">
                            Post ay : {informasi.tanggal_release}
                        </p>
                    </div>
                    <div>
