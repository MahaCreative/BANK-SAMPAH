...
export default function NewUpdate() {
    ...
    return (
        <>
            ...
            {informasi_update.data.length > 0
                ? informasi_update.data.map((item, key) => (
                              ...
                              <div className="flex gap-3 w-full">
                                  ...
                                  <div className="w-full">
                                      <Link
                                          ...
                                          className="hover:text-teal-600 block font-bold text-teal-400 border-b-4 border-teal-400"
                                      >
                                          {item.judul}
                                      </Link>
                                      <div className="flex justify-between w-full">
                                          ...
                                          <p className="text-[8pt] text-gray-700">
                                              Post at : {item.tanggal_release}
                                          </p>
                                      </div>
                                      <p className="text-[8pt] line-clamp-2">
                                      ...
                                      <Link
                                          ...
                                          className="text-gray-500 text-[8pt] hover:text-teal-400 font-light"
                                      >
                                          Selengkapnya...
                                      </Link>
                                  </div>
