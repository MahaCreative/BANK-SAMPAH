        ...
        <div>
            <Authenticated>
                <TextInput
                    ...
                    className={"block my-2.5 mx-4 w-[93%]"}
                    placeholder={"Search..."}
                />
                <PostUpdate />
                <div className="mx-4 my-2.5">
                    <h3 className="font-bold text-teal-500 text-xl border-b-4 border-teal-400">
                        Informasi
                    </h3>
                        ...
                        {informasi.length > 0 ? (
                            informasi.map((item, key) => (
                                <Link
                                    ...
                                    as="div"
                                    className="my-2.5 hover:cursor-pointer hover:bg-teal-300/50 py-2 px-2 rounded-md shadow-md shadow-gray-400/50"
                                >
                                    <img
                                        src={
                                            "../storage/" +
                                    ...
                                    />
                                    <h3 className="text-teal-400 my-2.5 font-bold border-b-2 border-teal-400">
                                        {item.judul}
                                    </h3>
